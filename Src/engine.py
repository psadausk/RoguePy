...
from Src.fov_functions import initialize_fov
from Src.fov_functions import recompute_fov
...
def main():
    ...
    while not libtcod.console_is_window_closed():
        ...
        render_all(con, entities, game_map, fov_map, update_fov, screen_width, screen_height, colors)
